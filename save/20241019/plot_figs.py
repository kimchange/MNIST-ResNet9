...
with open('../save/20241018_0.9/checkpoint_epoch107.pkl','rb') as f:
    np_checkpoint = pickle.load(f)


# pickle.dump((nn, loss_iter, loss_epoch, train_accuracy_epoch, label_pred_indices), f)
with open('../save/20241018_0.9/checkpoint_epoch199.pkl','rb') as f:
    np_checkpoint2 = pickle.load(f)

torch_checkpoint = torch.load('../save/torch_20241012_AdamW/checkpoint_epoch180.pt', weights_only=False)
torch_checkpoint2 = torch.load('../save/torch_20241012_AdamW/checkpoint_epoch199.pt', weights_only=False)
# dict_keys(['model', 'loss_iter', 'loss_epoch', 'train_accuracy_epoch', 'label_pred_indices'])
...
with open('../save/20241018_0.9/log.txt','r') as f:
    aa = f.readlines()
for ii in range(200):
...
axs[2,0].text(106., np_test_accuracy_epoch[106], f'epoch107\n{np_test_accuracy_epoch[106]}', **text_kwargs)
...
axs[2,1].text(179., np_test_accuracy_epoch[179], f'epoch180\n{np_test_accuracy_epoch[179]}', **text_kwargs)
