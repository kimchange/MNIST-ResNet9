...
class ResNet9:
    ...
    def backward(self, X, y_true, y_pred, learning_rate):
        ...
        output_gradient = self.block_avgpool2.backward(output_gradient)
        ...
        output_gradient = self.block_avgpool1.backward(output_gradient)
